...
export function CheckoutSummarySidebar({
  ...
  // Tổng thanh toán trọn gói (tiền hàng - giảm giá + phí vận chuyển)
  ...
  return (
    <aside className="rounded-2xl bg-neutral-50/70 p-6 border border-neutral-200/80 space-y-5 sticky top-24">
